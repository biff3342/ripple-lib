...
import { assertResult, TestSuite } from '../utils'
...
export default {
  'simple test': async (api, address) => {
    ...
    assertResult(response, responses.prepareSettings.flags, 'prepare')
  },
  ...
  'no instructions': async (api, address) => {
    ...
    assertResult(response, responses.prepareSettings.noInstructions, 'prepare')
  },
  'regularKey': async (api, address) => {
    ...
    assertResult(response, responses.prepareSettings.regularKey, 'prepare')
  },
  ...
  'flag set': async (api, address) => {
    ...
    assertResult(response, responses.prepareSettings.flagSet, 'prepare')
  },
  'flag clear': async (api, address) => {
    ...
    assertResult(response, responses.prepareSettings.flagClear, 'prepare')
  },
  ...
  'set transferRate': async (api, address) => {
    ...
    assertResult(response, responses.prepareSettings.setTransferRate, 'prepare')
  },
  'set signers': async (api, address) => {
    ...
    assertResult(response, responses.prepareSettings.signers, 'prepare')
  },
  ...
  'signers no weights': async (api, address) => {
    ...
    assertResult(response, responses.prepareSettings.noWeights, 'prepare')
  },
  'fee for multisign': async (api, address) => {
    ...
    assertResult(response, responses.prepareSettings.flagsMultisign, 'prepare')
  },
  'no signer list': async (api, address) => {
    ...
    assertResult(response, responses.prepareSettings.noSignerList, 'prepare')
  },
